...
package evervolv.androidterm.sample.pathbroadcasts;
...
public class PathReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
         ...
         * evervolv.androidterm.permission.APPEND_TO_PATH
         * to receive this broadcast.
         */
        if (action.equals("evervolv.androidterm.broadcast.APPEND_TO_PATH")) {
        ...
        /**
         * You need to declare the permission
         * evervolv.androidterm.permission.PREPEND_TO_PATH
         * to receive this broadcast.
         *
         ...
         */
        if (action.equals("evervolv.androidterm.broadcast.PREPEND_TO_PATH")) {
