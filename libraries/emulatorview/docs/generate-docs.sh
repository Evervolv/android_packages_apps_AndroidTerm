...
exec javadoc -d "$DOCDIR" -classpath "${SDK_DIR}/platforms/$TARGET_API/android.jar" -linkoffline http://developer.android.com/reference file:"${SDK_DIR}/docs/reference" -sourcepath "$DOCDIR/../src" evervolv.androidterm.emulatorview
